...
- **[Start fresh](/get-started/rad-template/)** – Use the RAD Template when you are bootstrapping a new full-stack experience. It brings Next.js, DDS wiring, auth, testing, CI/CD, and AI-friendly docs so you can ship quickly with consistent patterns.
