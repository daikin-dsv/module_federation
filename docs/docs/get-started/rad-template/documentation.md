...
| --------------------------------- | --------------------------------- |
| `docusaurus/package.json`         | CJS override for Docusaurus build |
| `docusaurus/docusaurus.config.ts` | Main Docusaurus configuration     |
| `docusaurus/docs/index.md`        | Welcome / landing page            |
| `docusaurus/docs/sidebars.ts`     | Sidebar navigation structure      |
| `docusaurus/docs/custom.css`      | Custom Docusaurus styles          |
| `docusaurus/docs/graphql-api.md`  | Example API reference doc         |
...
Every doc page should include YAML frontmatter at the top. `title` is displayed in the sidebar and browser tab; `sidebar_position` controls the ordering within a sidebar category:
