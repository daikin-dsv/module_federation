...
const Header = ({ navigationItems = [] }) => {
    ...
    return (
            <header
                className='flex flex-row justify-between items-center font-daikinSerif h-16 w-full min-w-[360px] border-b-1 border-(--dds-color-divider) pl-3 pr-4'
            >
                <div 
